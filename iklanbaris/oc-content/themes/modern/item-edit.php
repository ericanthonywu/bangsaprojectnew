...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content add_item">
            <h1><strong><?php _e('Update iklan', 'modern'); ?></strong></h1>
            <ul id="error_list"></ul>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="secret" value="<?php echo osc_item_secret() ;?>" />
                        <div class="box general_info">
                            <h2><?php _e('Informasi iklan', 'modern'); ?></h2>
                            <div class="row">
                                <label><?php _e('Kategori', 'modern'); ?> *</label>
                            ...
                            <div class="row price">
                                <label><?php _e('Harga', 'modern'); ?></label>
                        ...
                        <div class="box location">
                            <h2><?php _e('Lokasi', 'modern'); ?></h2>
                            <div class="row">
                                <label><?php _e('Negara', 'modern'); ?></label>
                                <?php ItemForm::country_select() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Provinsi', 'modern'); ?></label>
                                <?php ItemForm::region_text() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Kota/Kab.', 'modern'); ?></label>
                                <?php ItemForm::city_text() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Ds/Kec.', 'modern'); ?></label>
                                <?php ItemForm::city_area_text() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Alamat', 'modern'); ?></label>
                    ...
                    <a href="javascript:history.back(-1)" class="go_back"><?php _e('Batal', 'modern'); ?></a>
                </fieldset>
            </form>
        </div>
