                ...
                <div class="ad_list">
                    <div id="list_head">
                        <div class="inner">
                            ...
                            <p class="see_by">
                                <?php _e('Cari Berdasarkan', 'modern'); ?>:
                                <?php $i = 0 ; ?>
                    ...
                    <?php if(osc_count_items() == 0) { ?>
                        <p class="empty" ><?php printf(__('Tidak ada hasil yang ditemukan "%s"', 'modern'), osc_search_pattern()) ; ?></p>
                    <?php } else { ?>
 <?php $params['sShowAs'] = 'gallery'; ?>
 <a href="<?php echo osc_update_search_url($params) ; ?>"><?php echo 'Gallery'; ?></a>
 <?php $params['sShowAs'] = 'list'; ?>
 <a href="<?php echo osc_update_search_url($params) ; ?>"><?php echo 'List'; ?></a>
                ...
                $(function() {
                    ...
                    $( "#sCity" ).autocomplete({
                        ...
                        select: function( event, ui ) {
                            log( ui.item ?
                                "<?php _e('Terpilih', 'modern'); ?>: " + ui.item.value + " aka " + ui.item.id :
                                "<?php _e('Tidak ada yg di pilih, yang anda masukan adalah', 'modern'); ?> " + this.value );
                        }
                    });
                });
