$(document).ready(function(){
	...
	$( ".sortable" ).sortable({
		...
		receive: function (event, ui) {
			...
			$.ajax({
				type: 'POST',
				url: 'kelola.php?r=blockmobile/AjaxAddItem',
				dataType: 'json',
				data: {addItem: qwer},
	...
	$('div.panel-body').on('click', '.ajaxContentDelete', function(){
		...
		if(xs){
			$.ajax({
				type: 'POST',
				url: 'kelola.php?r=blockmobile/AjaxRemoveItem',
				dataType: 'json',
				data: {removeItem: z},
				success: function(data){
					if(!data){
	...
	$('#ajaxMenuPost').click(function(){
		...
		$.ajax({
			type: 'POST',
			url: 'kelola.php?r=blockmobile/AjaxHomeBlock',
			dataType: 'json',
			data: {ajaxPost: arr},
			success: function(data){
				if(!data){
	...
	$('#addSeparator').click(function(){
		$.ajax({
			type: 'POST',
			url: 'kelola.php?r=blockmobile/AddSeparator',
			dataType: 'json',
			data: {ajaxPost: "Aw"},
			success: function(data){
				if(!data.a){
