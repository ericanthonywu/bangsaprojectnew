						...
						foreach($kategoris as $kategori):?>
							<div class="alert btn-green strshp draggable" data-kid="" data-id="<?php echo $kategori['category_id']; ?>" data-type="category">
								...
								<div class="block-holder pull-right">
									...
									<label><input type="radio" name="jenisBlok[<?php echo $kategori['category_id']; ?>]" value="1" checked /> Style 1</label>
								...
								foreach($grpsWidgets as $grpsWidget):?>
									...
									<?php elseif($grpsWidget['widget_type'] == "iklan"):?>
										<div class="block-holder pull-right" style="margin-right:5px;">
											<label class=""><?php echo ucfirst($grpsWidget['widget_type']); ?> | </label>
											<label>
												<input type="radio" name="jenisBlok[<?php echo $grpsWidget['widget_id']; ?>]" value="1" <?php echo ($grpsWidget['widget_style']==1) ? "checked=checked" : ""; ?> /> Gambar</label>
											<label style="margin:0 10px 0 0;">
												<input type="radio" name="jenisBlok[<?php echo $grpsWidget['widget_id']; ?>]" value="2" <?php echo ($grpsWidget['widget_style']==2) ? "checked=checked" : ""; ?> /> Text</label>
										</div>
									<?php endif;?>
										</div>
						<?php	endforeach;?>
