...
<link rel='stylesheet' type='text/css' href='<?php echo Yii::app()->baseUrl; ?>/js/select2/select2.css' />
	...
	<!-- BEGIN SIDEBAR MENU -->
		<ul class="acc-menu" id="sidebar">
			...
			<?php 
				...
				if($item['module_name'] == 'tag'): continue; endif;
			?>
			...
			<?php endforeach; ?>
			<li><a href="javascript:;"><i class="icon-comment"></i> <span>Tag Berita</span></a>
				<ul class="acc-menu">
					<li><a href="<?php echo Yii::app()->createUrl('tags'); ?>">Semua Tag Berita</a></li>
				</ul>
			</li>
			...
			<li><a href="javascript:;"><i class="icon-thumbs-up"></i> <span>Polling Pemilu</span></a>
				<ul class="acc-menu">
					<li><a href="<?php echo Yii::app()->createUrl('poll/poll2/index'); ?>">Semua Polling Pemilu</a></li>
					<li><a href="<?php echo Yii::app()->createUrl('poll/poll2/create'); ?>">Tambah Polling Pemilu</a></li>
				</ul>
			</li>
			...
			<li class="hasChild">
				...
				<ul class="acc-menu">
					<li><a href="<?php echo Yii::app()->createUrl('settingpolling'); ?>">Pengaturan Polling</a></li>
					<li><a href="<?php echo Yii::app()->createUrl('content'); ?>">Pengaturan Halaman Depan</a></li>
					<li><a href="<?php echo Yii::app()->createUrl('blockmobile'); ?>">Pengaturan Halaman Depan Mobile</a></li>
					...
					<li><a href="<?php echo Yii::app()->createUrl('ioptionsmobile'); ?>">Pengaturan Iklan Mobile</a></li>
					<li><a href="<?php echo Yii::app()->createUrl('topik'); ?>">Pengaturan Topik Khas</a></li>
					<li><a href="<?php echo Yii::app()->createUrl('options/stickyhotnews'); ?>">Pengaturan Sticky Hotnews</a></li>
					<li><a href="<?php echo Yii::app()->createUrl('options'); ?>">Pengaturan Link Sosial Media</a></li>
				</ul>
			</li>
			<li class="divider"></li>
		</ul>
    ...
    <footer role="contentinfo">
        <div class="clearfix">
            <ul class="list-unstyled list-inline">
                <!-- <li>Supported by 99 ITDesigns. Created Azzamedia &copy; 2013</li> -->
                <li>Supported by 99 ITDesigns &copy; 2013</li>
...
<script type='text/javascript' src='<?php echo Yii::app()->baseUrl; ?>/js/select2/select2.min.js'></script>
<script type='text/javascript' src='<?php echo Yii::app()->baseUrl; ?>/js/demo.js'></script>

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.9.1/themes/base/jquery-ui.min.css">
<script type="text/javascript">
	$(document).ready(function(){
		//datepicker
	    $('#datepicker, .datepicker, .datepic').datepicker({
	        dateFormat: "yy-mm-dd",
	        minDate: 0,
		});
    });
