	...
	<div class="col-md-9">
		<div class="panel panel-primary panel-green">
			<div class="panel-heading">
				<h4>Pengaturan Halaman Depan Mobile</h4>
			</div>
			<?php echo CHtml::beginForm('', 'post', array('id'=>'ajaxkonten')); ?>
			<div class="panel-body sortable">
				<?php 	$kategoris = Yii::app()->db->createCommand()->select('level, block_style, id, block_title, block_type, block_object_id')->from('block_mobile')->where('block_type != "root"')->order('lft ASC')->queryAll();
						foreach($kategoris as $kategori):?>
