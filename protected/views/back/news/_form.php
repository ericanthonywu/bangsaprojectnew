...
/* @var $form CActiveForm */
	...
	$uploadurl = Yii::app()->createUrl('news/uploades');
?>
			...
			<div class="panel panel-green">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<?php echo $form->textArea($model,'embed',array('class'=>'form-control')); ?>
						<p class="help-block">Contoh: Youtube ID NXXSSS (youtube.com/watch?v=NXXSSS)</p>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<?php echo $form->textField($model,'news_penulis',array('class'=>'form-control', 'placeholder'=>'Penulis Berita', 'required'=>'required')); ?>
					</div>
					<div class="form-group">
