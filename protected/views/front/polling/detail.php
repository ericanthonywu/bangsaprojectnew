...
<div class="row bo-main">
	...
	<div class="span8 mb1 mt1"> 
		...
		<div class="title-category fz-20">
			<h1><?php echo ucwords($data['judul']); ?></h1>
		</div>
		...
		<div class="details_polling_dtn">
			...
			<?php if ($data['list_pil']): ?>
				...
				<div class="form-group">
					<div class="radio">
					  <label>
					  	<img src="<?php echo Yii::app()->baseUrl; ?>/images/uploads/polling/<?php echo $value->image ?>" alt="<?php echo $value->label ?>" class="img-responsive">
			...
			<div class="padding-left-15">
				...
				<div class="form-group">
					<button class="btn btn-primary" type="submit">Voting</button>
				</div>
				<?php endif; ?>
			</div>
			</form>
					...
					<div class="row">
						<div class="col-xs-3">
							<a href="#" class="thumbnail">
						      <img src="<?php echo Yii::app()->baseUrl; ?>/images/uploads/polling/<?php echo $valu['image'] ?>" alt="<?php echo $valu['title_s'] ?>" class="img-responsive">
						    </a>
						</div>
						<div class="col-xs-9">
