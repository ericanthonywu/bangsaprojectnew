	...
	<div class="sub-row">
		...
		<?php if($datab['block_type'] == "category"){ ?>
			<?php 
				...
				$sqlnewshimage = "SELECT b.news_id, b.news_slug, b.news_title, b.news_date, f.filename FROM category_relationship cr INNER JOIN module_news b ON(cr.post_id = b.news_id) INNER JOIN files f ON(cr.post_id = f.object_id) WHERE cr.category_id = '$thiscat' AND f.module_id = 1 AND b.news_type = 1 AND b.news_status = 1 ORDER BY b.news_id DESC LIMIT 1";
