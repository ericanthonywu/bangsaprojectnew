...
<div class="block-iklan-4">
	<?php 
		$mio = Yii::app()->db->createCommand("SELECT style, object_id FROM module_iklan_options WHERE position = 'iklan-bawah-1'")->queryRow();?>
	...
	<?php endif;?>
	<?php 
		$mio = Yii::app()->db->createCommand("SELECT style, object_id FROM module_iklan_options WHERE position = 'iklan-bawah-2'")->queryRow();?>
	<?php if($mio['object_id'] != 0):?>
