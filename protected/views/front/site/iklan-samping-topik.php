...
<?php 
	$mio = Yii::app()->db->createCommand("SELECT style, object_id FROM module_iklan_options WHERE position = 'samping-topik-1'")->queryRow();?>
	...
	<?php endif;?>
<?php
	$mio = Yii::app()->db->createCommand("SELECT style, object_id FROM module_iklan_options WHERE position = 'samping-topik-2'")->queryRow();?>
	<?php if($mio['object_id'] != 0):?>
	<div class="iklan mt1">
	<?php 	if($mio['style'] == 0):
