	...
	<div class="span8 mb1 mt1"> 
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<div class="row mb1">
				...
				<div class="span5">
					<?php echo $form->textField($model,'news_title',array('class'=>'form-control', 'placeholder'=>'Tulis judul berita')); ?>
				</div>
			</div>
			<div class="row mb1">
				<div class="span2">
				...
				<div class="span5">
					<?php echo $form->textArea($model,'news_content',array('class'=>'form-control', 'placeholder'=>'Tulis isi berita', 'style'=>'max-width:495px;min-width:495px;min-height:200px;')); ?>
				</div>
			</div>
			<div class="row">
				<div class="span2">
