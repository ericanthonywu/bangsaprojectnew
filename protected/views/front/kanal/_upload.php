			...
			<div class="rows">
				<div class="rows">
					...
					<div class="col-md-12" style="margin-bottom:5px;overflow:hidden;">
						...
						<span class="col-md-10 "><textarea class="form-control" name="page_caption_description" rowss="3" required placeholder="Deskripsi Caption"></textarea></span>
					</div>
					<div class="col-md-12">
						<span class="rows">
							{% if (file.error) { %}
