...
<body>
	<?php 
		...
		echo "Q1 = SELECT style FROM module_iklan_options WHERE position = 'atas' ";
	?>
	<!-- Top Iklan -->
	...
	<div class="container">
		<?php 
			...
			echo "Q3 = SELECT style FROM module_iklan_options WHERE position = 'samping-halaman-kiri'";
			?>
		<!-- Iklan Samping Kiri -->
		...
		<div class="row bo-header clearfix">
			<div class="headerblock1 clearfix">
				...
				<?php 
					...
					echo "Q5 = SELECT style FROM module_iklan_options WHERE position = 'samping-logo'";
						if($mio['style'] == 0):
