		...
		<?php endforeach; ?>
			...
			<div class="span3">
				<div style="margin:10px 0 0 0;">
					...
					<div></div>
					<input id="settings_password" type="password" name="Auth[password]" value="" />
				</div>
				<div style="margin:10px 0 0 0;">
					<label for="settings_password">
					...
					<div></div>
					<input id="settings_repassword" type="password" name="Auth[repassword]" value="" />
				</div>
				<div style="margin:10px 0 0 0;">
					...
					<div></div>
					<input id="settings_finame" type="text" name="Auth[firstname]" value="<?php echo $aw['firstname']; ?>" />
				</div>
				<div style="margin:10px 0 0 0;">
					...
					<div></div>
					<input id="settings_lname" type="text" name="Auth[lastname]" value="<?php echo $aw['lastname']; ?>" />
				</div>
				<div style="margin:10px 0 0 0;">
					...
					<div></div>
					<input id="settings_fname" type="email" name="Auth[email]" value="<?php echo $aw['email']; ?>" />
				</div>
				<div style="margin:10px 0 0 0;">
