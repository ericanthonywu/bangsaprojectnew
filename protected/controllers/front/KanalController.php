	...
	public function actionDetail($slug)
	{
		if(isset($_GET['slug'])){
			...
			if($kanal_cache===false)
			{
				...
				$sql = "SELECT * FROM `view_kanal_news` b
					WHERE b.category_slug= '$slug' AND b.news_status='1' AND b.news_type='1' AND b.module_id = '1'  ORDER BY b.news_id DESC LIMIT $start,$limit";			
