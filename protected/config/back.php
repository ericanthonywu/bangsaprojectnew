...
return CMap::mergeArray(
    ...
    array(
		...
		'import'=>array(
			...
			'application.modules.poll2.models.*',
			'application.modules.poll2.components.*',
		),
		'aliases'=>array(
			'xupload' => 'ext.xupload'
		),
		'modules'=>array(
			...
			'gii'=>array(
				...
				'ipFilters'=>array('127.0.0.1', '192.168.1.109', '192.168.1.110','::1'),
			),
		...
		'components'=>array(
		   ...
		   //              'ipFilters'=>array('127.0.0.1', '192.168.1.109', '192.168.1.110'),
		   //          ),
