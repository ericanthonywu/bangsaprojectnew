 ...
 */
class Poll2 extends CActiveRecord
{
  /**
   ...
   * @return Poll2 the static model class
   */
  ...
  public function rules()
  {
    return array(
      ...
      array('description, rekayasa, date_end, date_input', 'safe'),
  ...
  {
    return array(
      'choices' => array(self::HAS_MANY, 'Poll2Choice', 'poll_id'),
      'votes' => array(self::HAS_MANY, 'Poll2Vote', 'poll_id'),
      'totalVotes' => array(self::STAT, 'Poll2Choice', 'poll_id', 'select' => 'SUM(votes)'),
    );
  }
  ...
  public function search()
  {
    ...
    $criteria->compare('rekayasa',$this->rekayasa);
